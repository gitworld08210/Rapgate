...
class AppConstants {
  ...
  // The following Firebase-era constants were removed as dead code:
  // - Firestore collection paths (usersCollection, foodLogsSubcollection, etc.)
  // - Cloud Function endpoints (cfScanFoodImage, cfSearchFoodByBarcode, etc.)
  // - functionsRegion
  // All functionality now uses Supabase Edge Functions and Postgres tables.
}
