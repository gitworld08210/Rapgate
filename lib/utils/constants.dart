...
class AppConstants {
  ...
  // Postgres table names (Supabase). Kept for reference; data access goes
  // through the typed services in lib/services.
  ...
  static const String pushupSessionsTable = 'pushup_sessions';
  static const String blockedAppsConfigTable = 'blocked_apps_config';
  static const String streaksTable = 'streaks';
  static const String finesTable = 'fines';
  static const String emergencyUnlocksTable = 'emergency_unlocks';
  static const String accountabilityLinksTable = 'accountability_links';
}
